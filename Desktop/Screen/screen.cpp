...
//右键菜单
void Screen::contextMenuEvent(QContextMenuEvent *event)
{
    Q_UNUSED(event)
...
void Screen::MenuClose()
{
    rectangle.setRect(0,0,0,0);
    this->close();
}

void Screen::SrceenValInit()
{
